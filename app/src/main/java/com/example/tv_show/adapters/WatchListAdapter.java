...
public class WatchListAdapter extends RecyclerView.Adapter<WatchListAdapter.TvShowViewHolder> {
    ...
    private WatchListLinstener watchListLinstener;

    public WatchListAdapter(List<TvShow> tvShows, WatchListLinstener watchListLinstener) {
        this.tvShows = tvShows;
        this.watchListLinstener = watchListLinstener;
    }
    ...
    class TvShowViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindTvShow(TvShow tvShow) {
            ...
            itemTvShowBinding.getRoot().setOnClickListener(view -> watchListLinstener.onTvShowClicked(tvShow));
            itemTvShowBinding.imageDelete.setOnClickListener(view -> watchListLinstener.removeTVShowFromWatchList(tvShow, getAdapterPosition()));
